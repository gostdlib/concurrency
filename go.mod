module github.com/gostdlib/concurrency

go 1.26.4

require github.com/johnsiilver/pools v0.0.0-20221216174331-e94bf08bc72b // indirect
...
require (
	...
	github.com/gostdlib/deps v0.0.0-20260618182714-aa0489fb9f69 // indirect
